...
const MAP = {
  ...
  configFormatHeader: 'match_config_format_header',
  configOptionsHeader: 'match_config_options_header',
  configStatsHeader: 'match_config_stats_header',
  tbOnlyPointsLabel: 'match_config_tb_only_points',
  ...
  tutorialExit: 'tutorial_exit',
  tutorialNext: 'tutorial_next',
  tutorialBack: 'tutorial_back',
  tutorialSkip: 'tutorial_skip',
  tutorialLater: 'tutorial_later',
  tutorialBannerTitle: 'tutorial_banner_title',
  tutorialBannerMessage: 'tutorial_banner_message',
  tutorialDemoTournament: 'tutorial_demo_tournament',
  tutorialDemoPlayer1First: 'tutorial_demo_player1_first',
  tutorialDemoPlayer1Last: 'tutorial_demo_player1_last',
  tutorialDemoPlayer2First: 'tutorial_demo_player2_first',
  tutorialDemoPlayer2Last: 'tutorial_demo_player2_last',
  tutorialCourtTitle: 'tutorial_court_title',
  tutorialCourtBody: 'tutorial_court_body',
  tutorialPinTitle: 'tutorial_pin_title',
  tutorialPinBody: 'tutorial_pin_body',
  tutorialPlayersTitle: 'tutorial_players_title',
  tutorialPlayersBody: 'tutorial_players_body',
  tutorialConfigTitle: 'tutorial_config_title',
  tutorialConfigBody: 'tutorial_config_body',
  tutorialServeSwapTitle: 'tutorial_serve_swap_title',
  tutorialServeSwapBody: 'tutorial_serve_swap_body',
  tutorialServePickTitle: 'tutorial_serve_pick_title',
  tutorialServePickBody: 'tutorial_serve_pick_body',
  tutorialBasicTitle: 'tutorial_basic_title',
  tutorialBasicBody: 'tutorial_basic_body',
  tutorialDoubleFaultTitle: 'tutorial_double_fault_title',
  tutorialDoubleFaultBody: 'tutorial_double_fault_body',
  tutorialSideChangeTitle: 'tutorial_side_change_title',
  tutorialSideChangeBody: 'tutorial_side_change_body',
  tutorialSetBreakTitle: 'tutorial_set_break_title',
  tutorialSetBreakBody: 'tutorial_set_break_body',
  tutorialTiebreakTitle: 'tutorial_tiebreak_title',
  tutorialTiebreakBody: 'tutorial_tiebreak_body',
  tutorialUndoTitle: 'tutorial_undo_title',
  tutorialUndoBody: 'tutorial_undo_body',
  tutorialFinishTitle: 'tutorial_finish_title',
  tutorialFinishBody: 'tutorial_finish_body',
  tutorialRetirementTitle: 'tutorial_retirement_title',
  tutorialRetirementBody: 'tutorial_retirement_body',
  tutorialCompleteTitle: 'tutorial_complete_title',
  tutorialCompleteBody: 'tutorial_complete_body',
};
