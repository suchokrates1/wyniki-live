...
export function toMatchPayload(state) {
  return {
    ...
    serve: state.isPlayer1Serving ? 'A' : 'B',
    player1: { is_serving: Boolean(state.isPlayer1Serving) },
    player2: { is_serving: !state.isPlayer1Serving },
    ...
    match_config: {
      ...
      tiebreak_at_games: state.matchConfig.tiebreakAt,
...
export function toDirectorSnapshot(state) {
  ...
  return {
    ...
    tiebreak_at_games: payload.match_config.tiebreak_at_games,
