  ...
  return {
    ...
    scoreboardLabels() {
      ...
      return {
        ...
        groupRematch: history.phaseGroupRematch,
        knockout: history.phaseKnockout,
        r16: scoreboard.phaseR16 || '1/8',
        qf: scoreboard.phaseQF,
        sf: scoreboard.phaseSF,
        final: scoreboard.phaseFinal || bracket.finalLabel,
        third: bracket.thirdPlace,
      };
    },
