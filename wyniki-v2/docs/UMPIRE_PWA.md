...
1. Close **Blind Tennis Referee** completely (swipe it away in Recents). Do not leave it in the background.
...
Settings → **Start tutorial**, or the first-run banner (**Later** skips it). The walkthrough uses a fake court, PIN `1234`, and two demo players. It does not call the API, write the outbox, or finish a real match. Replay anytime from Settings.
