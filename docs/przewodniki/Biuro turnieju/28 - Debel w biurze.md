...
> [!important] Ci sami zawodnicy
> Deblowcy to ci sami zawodnicy co w singlu — grają w obu kategoriach. Zawodnik z pary nadal musi być rozlosowany w swojej grupie singlowej, a planer nie da mu o tej samej godzinie singla i debla.
...
| `knockout` | Tylko puchar | **nie** | drabinka z listy par w kolejności rozstawienia — dowolna liczba par (wolne losy dla najwyżej rozstawionych, finał i 3. miejsce), jak deble w Wilnie |
...
| `15_lang_lt` | `?lang=lt` |
| `21_full_tournament_office` | pary z formularza i losowanie, wynik debla w pełnym turnieju |
| `22_lifecycle_wbtc_scale` | deble z Wilna (5–11 par) jako drabinki z zawodników singlowych; nikt na dwóch kortach naraz |
